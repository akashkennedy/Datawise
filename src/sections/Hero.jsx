...
const Hero = () => {
  return (
    <section className="flex h-screen flex-col gap-5 px-5 pt-10 md:flex-col md:gap-10 lg:flex-row lg:items-center lg:justify-between lg:px-20">
      ...
      <img src={HeroWrapper} alt="Hero Wrapper" className="md:w-1/2 md:self-end lg:w-fit lg:self-center"/>
    </section>
  );
};
